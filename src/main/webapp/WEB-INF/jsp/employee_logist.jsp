...
<script>
    ...
    $('#logistTable').append($('<tr>')
        .append($('<td>').append($('<input type="number" name="id" readonly value="'+ emploeeLogist.id +'">')))
        ...
        .append($('<td>').append($('<textarea name="info">').append(logist!=null?logist.info:"")).append($('<input type="submit" value="Изменить">')))
        .append($('<td>').append('<input type="button" value="X" onclick="deleteLogist(this.parentElement.parentElement.firstChild.firstChild.value)">'))
    );
